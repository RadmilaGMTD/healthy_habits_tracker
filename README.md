...
Healthy Habits Tracker — это сервис для выработки полезных привычек с системой напоминаний через Telegram и мотивационными вознаграждениями. Основные возможности:

* Создание персональных привычек с настраиваемой периодичностью

* Автоматические напоминания в Telegram

* Система вознаграждений (приятные привычки или другие поощрения)

* Публичные привычки для мотивации других пользователей
